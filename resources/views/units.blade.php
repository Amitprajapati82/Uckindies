			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="section-title">
						<h2 class="color-orange">About Uckindies Play School Maharashatra</h2>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="section-title">
						...
						<p>Our vibrant learning environment is designed to bring out the playfulness in kids, which is backed by
qualified and well-trained teachers and caring support staff.
</p>
					</div>
					<!-- Section title end -->
				</div>
...
<!--        <h1 class="mb-3 mt-3">LEARNING CENTER</h1>-->
<!--    </div>-->
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="contact-info">
						...
						<p class="email">
					    <a href="mailto:admin.india@uckindies.com">admin.india@uckindies.com</a></p>
                        <p class="contact">
