            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12 mb-3">
                    <div class="form-group p-0">
                        ...
                        <input type="text" class="form-control input-full input-pill" id="TitleName" name="TitleName" placeholder="Enter Title" required value="" >
                ...
                <!-- <div class="col-12 col-md-6 col-lg-6 mb-3"> -->
                    <div class="form-group p-0 mt-3">
                        ...
                        <span class="text-danger"> *</span>
                        <input type="file" class="form-control input-full input-pill" id="AboutImage" name="AboutImage">
                        @error('AboutImage')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
