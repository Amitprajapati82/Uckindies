...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let defaults = {
            ...
            extensions: ['.jpg', '.jpeg', '.png', '.gif', '.svg', '.pdf', '.docx', '.xlsx', '.doc', '.xls'],
            mimes: ['image/jpeg', 'image/png', 'image/gif', 'image/svg+xml','application/pdf','application/vnd.openxmlformats-officedocument.wordprocessingml.document','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet','application/msword','application/vnd.ms-excel'],
            maxSize: undefined,
            maxFiles: undefined,
        };
